...
export default class Samurai extends Handler {

  static instance;

  static getInstance() {
    if (!Samurai.instance) {
      Samurai.instance = new Samurai();
    }

    return Samurai.instance;
  }
  ...
  setupSamurai() {
    const mask = this.resources.models.samurai.scene.children[0];
...
window.addEventListener('DOMContentLoaded', () => {
  new Experience(document.querySelector('canvas.experience__canvas'), Samurai);
})