...
export default class Cyborg extends Handler {

  static instance;

  static getInstance() {
    if (!Cyborg.instance) {
      Cyborg.instance = new Cyborg();
    }

    return Cyborg.instance;
  }
  ...
  setupCyborg() {
    const mask = this.resources.models.cyborg.scene.children[0];
...
window.addEventListener('DOMContentLoaded', () => {
  new Experience(document.querySelector('canvas.experience__canvas'), Cyborg);
})